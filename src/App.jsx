...
<section id="achievements" className="achievements-section">
  ...
  <div className="achievements-grid">
    <div className="achievement-card">
      ...
      <img src="public/images/AWS.jpg" alt="AWS Certificate" className="achievement-img" />
    </div>
...
GestureSmart is an intelligent calculator that allows users to perform mathematical operations using hand gestures, offering a touch-free and interactive computing experience.
    ...
    {/* ✅ Project 3 */}
    <div className="project-card">
      <img src="images/Simple_notes_managementjpg.jpg" alt="Simple-Notes-Management-System" className="project-img" />
      <div className="project-info">
        <h3 className="project-title">Simple Notes Management System</h3>
        <p className="project-description">
A web application built using Python, Flask, and MySQL for creating, managing, and organizing notes securely with user authentication and an easy-to-use interface.        </p>
        <p className="project-tech">Tech Stack: Python, Flask, MySQL, HTML, CSS, JavaScript</p>
        <a href="https://github.com/Keerthi9092/Simple-Notes-Management-System" className="project-btn" target="_blank" rel="noreferrer">
          View Project
        </a>
      </div>
    </div>
